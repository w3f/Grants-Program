...
N3MUS is already live on Moonbeam, where the platform and participating games account for 8% of all Moonbeam daily network traffic, with 109% month-over-month growth. As we expand deeper into the Polkadot ecosystem, we will leverage XCM and parachain integrations to manage tournament creation, reward distribution, and result publishing in a transparent and verifiable way, while respecting the technical limitations and roles of each parachain.
...
- **What studios on Moonbeam are currently saying about N3MUS**:
    ...
    ⚠️ **We are applying for a grant where 85% of the funding will be allocated to Community Incentives, directly growing the ecosystem and incentivizing activity across games and parachains on Polkadot.**
...
The upcoming PolkaVM/Solidity competiability on the AssetHub brings us a great oppertunity to deploy our smart contracts there and bring the traction directly to Polkadot. We will fully open source the whole integration stack required to run on-chain tournaments including the smart contracts, unity/unreal SDKs, scripts etc!
...
N3MUS is a layer for gamified engagement across Polkadot ecosystem-native games. We are bridging community interaction, competitive mechanics, and transparent scorekeeping into one stack.

- **Target Audience:**
    - Game studios building on Polkadot;
    - Web2 games and gamers;
...
- ### Legal Structure
    ...
    - **Registered Legal Entity:** N3MUS Inc.
...
- ## Milestone 1 – Q1-Q2 2025: Polkadot Integration & Launch ($20,000)
 15% of the Grant will be used for staffing and infrastructure cost, 85% will be returned to the ecosystem users and studios in the form of Tournament Prize Money.
...
|--------|-------------|---------------|
| 1 | Onboard Polkadot as 'ORGANIZATION' within N3MUS | Launch initial test tournament with on-chain leaderboard + rewards |
| 2 | Integrate at least three games from the Polkadot Ecosystem |
| 3 | Conduct between 17-34 tournaments, depending on the prizepool |
| 4 | Execute on-chain missions and social media missions which is fully around Polkadot |
...
| Number | Deliverable | Specification |
|--------|-------------|---------------|
| 1 | Integrate at least additional 5 Games (possibly including Mythical Games) |
| 2 | Conduct 50-100 tournaments, depending on the prizepool |
| 3 | Achieve 200,000+ Gameplays | Across integrated games, tracked and verified on-chain |
| 4 | Work together with HEROIC to implement a CS2 tournament and leverage blockchain as a technology (we are currently already doing this together with Flamengo (48m fans, biggest in LatAm) and Moonbeam https://x.com/flaesports/status/1906814609140432966 |
...
| Number | Deliverable | Specification |
|--------|-------------|---------------|
| 1 | Integrate at least 5 Additional Games | Including 2 brand-new games deployed on Polkadot rollups |
| 2 | Launch High-Impact Tournaments | With custom campaigns (e.g., CS2, LoL mod, sponsored events) |
| 3 | Reach 400,000+ Total Gameplays | Cumulative gameplay activity tracked on-chain |
| 4 | Gamer Onboarding Campaigns | With a high focus on web2 gamers
| 5 | Mid-Point Report | Publish Polkadot case study with developer feedback, metrics, and learnings |
...
| Number | Deliverable | Specification |
|--------|-------------|---------------|
| 1 | Run 3 Flagship Tournaments | Cross-game, on-chain tournaments targeting 25K-100K+ participants |
| 2 | Final Ecosystem Report | Includes interviews, community feedback, and recommendations |
| 3 | Developer Roundtable | Engage game teams to shape future feature development |
| 4 | Expand to 15+ Integrated Games | Ensure ongoing ecosystem growth with tournament support |
...
**How did you hear about the Grants Program?**
    ...
    - Via the Web3 Foundation Website and Polkadot Forum and we were encouraged by many people within the ecosystem!
**Additional Notes:**
