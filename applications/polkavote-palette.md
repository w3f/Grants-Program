...
By implementing an OG, battle tested protocol - "The Open Vote Network" we can introduce an anonymous protocol that is actually running on a Polkadot chain, by leveraging Polkadot-sdk and Noir/Circom for ZK.
