...
|2b.|Manipulator implementation|The manipulator will proxy the queuries via a `call` to the bridge and IOU contracts. The complexity of our function makes us reach the limit of EVM stacks of 16 words, we then needed to use optimisation and assembly |Manipulator: [Repository](https://github.com/Perpetual-Altruism-Ltd/myNFT-Bridge/tree/05bc177087f4fdba1662b71cadb54afa82185513/Codebase/Manipulator_Contracts), [Guide](https://github.com/Perpetual-Altruism-Ltd/myNFT-Bridge/blob/master/MANIPULATOR.md)|
|2c.|Manipulator implementation||Manipulator: [Repository](https://github.com/Perpetual-Altruism-Ltd/myNFT-Bridge/tree/05bc177087f4fdba1662b71cadb54afa82185513/Codebase/Manipulator_Contracts), [Guide](https://github.com/Perpetual-Altruism-Ltd/myNFT-Bridge/blob/master/MANIPULATOR.md)|
