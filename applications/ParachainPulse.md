...
| 0b. | Documentation | We will provide both documentation of the code and a video tutorial that explains how a user can easily use ParachainPulse app |
...
| 9. | Build the parachains table | Build the parachains table where each text column can be filtered and numerical column sorted |
| 10. | Build the parachains table | Display the name of each parachain in the Polkadot and Kusama's ecosystems |
...
| 27. | Build the parachain table | Display the developer's GitHub logo and name |
| 28. | Build the parachain table | Display the number of contributions it made to the parachain |
