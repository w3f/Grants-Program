...
First milestone (15K)
AI NFT Generator on Polkadot ecosystem (1,5 month):
1. Polkadot protocol analysis: 
- Two blockchain/back-end developers 
2. AI NFT Generator (WEB platform) preparation on Polkadot ecosystem:
- Two AI/back-end developers 
3. Polkadot NFT smart contract preparation with AI generator
- Two blockchain/back-end developers 
4. Web application development and UX/UI
- UX/UI designer, Front-end developer
Milestone 2 Example — Additional features
Second milestone (15K)
Qlone AI NFT smart contracts on Polkadot ecosystem (1,5 month):
1. Polkadot NFT smart contract development:
- Two blockchain/back-end developers 
2. Polkadot NFT smart contract implementation on AI NFT Generator:
- Two blockchain/back-end developers 
3. AI NFT Generator back-end API development:
- Two blockchain/back-end developers 
4. Polkadot wallet integration and connection for minting
- Two blockchain/back-end developers
Future Plans
