...
- A GitHub Action to build the release runtime and node files.
...
|     5. | WASM info inspect tool        | Use it to inspect the WASM basic information and integrate the result into the release note.                          |
