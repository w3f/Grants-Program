...
- Are there any other projects similar to yours in the Substrate / Polkadot / Kusama ecosystem?
  ...
  This airdrop application will be used to serve the Dota 2.0 network and can also cater to any projects with airdrop needs. Ongoing token airdrop activities are especially important for purely community-driven projects, and this application will be frequently utilized by Dota 2.0.
