...
From the official W3F Website and the official polka-dot webs and Twitter.

Please don't refuse grant proposal for Bika, I really need grant funds for development on Polkadot, Substrate and W3F for a better life with Crypto, I will build Bika Novel and BikaSwap or Dapps apps for Polkadot token exchange, Ethereum and Bep-20, I request that Bika get Grant level 1 for development, I will fully contribute to Web3, so please pay attention and provide grant assistance to Bika, I promise to use grant funds from W3F properly and regularly for Web3 and project purposes, I hope W3F  is more good in making decisions, hopefully W3F can help the Bika project.
