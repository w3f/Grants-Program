...
| 2. | Implement Controller Account Support | Implementation to detect account type (stash/controller) in the background and accordingly allow the user to stake through YieldScan. <br><br> **How to verify deliverable**: you will be able to use YieldScan with a different controller and stash account. 
