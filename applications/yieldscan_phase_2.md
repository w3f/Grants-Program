...
| 2. | Implement Controller Account Support | Integrating the design changes for controller account as well as help user with why behind setting up controller account and then provide the ability to setup stash and controller setup. <br><br> **How to verify deliverable**: you will be able to use YieldScan with a different controller and stash account. 
