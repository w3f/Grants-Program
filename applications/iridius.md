...
| 0c. | Testing Guide | This milestone is already packed with getting a demo implementation working so we would provide-coverage partial system tests for the MPC software and the smart contract. The next milestone will invest more in finalising and testing that software.  |
...
| 0c. | Testing Guide | We will provide a complete suite of tests for the on-chain smart contract. |
