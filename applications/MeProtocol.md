...
| 3. | Build out Inter-spendability of Rewards on the ME APP| We will implement all the necessary screens and provide all the necessary services and microservices that will allow users to in the most frictionless way redeem their rewards on offers across brands of their choice, provided the brands have been supported on the protocol. <br> **Languages and framework:** TypeScript, Nestjs, Reactjs, Polkadotjs, PostgreSql|
...
