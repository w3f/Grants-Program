...
| 2.     | API                              | A unified storage API that provides fast storage and retrieval capabilities. |
| 3.     | Weights/Benchmarking             | implement benchmarking for pallet_storage to determine appropriate weights. |
