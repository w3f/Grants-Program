...
| 2. | Identiy ISO20022 message types and examples for X-border payment | Specify all ISO20022 message types with examples for cross border payment, including reference data fields | 
...
| 8. | Recommend blockchain gas fees handling in ISO20022 framework | Recommend solution how to fulfil blockchain gas fees in ISO20022 framework |
