...
#### Integration
We designed the substrate pallet to obtain the strength of Machine Learning algorithms for all substrate-base blockchains (parachains).
#### Motivation
...
### Project Details
Substrate pallet provide a configurable machine learning module with allowance to use Machine Learning algorithms and its results on-chain. Module will be integrated with OrbitDb. Dataset will be securely stored in IPFS and users will have an opportunity to control access for the provided data.
...
Integration with one of our projects - [Trusted Health Council](https://docs.google.com/document/d/1BcmZDwZ0bJpfC78lgPgaQfQKRVvAZvedemAx6EeZzfs/edit?usp=sharing)

## Additional Information :heavy_plus_sign:

We have already developed the pre-alfa pallet for the project in health care production (Trusted Health Counsil) There are we use Random Forest algorithms allows to do classification and regression to test predicting diabetes or cancer.

### Other foundation
We have tried for General Grant first, and decided to start with Open one reliying on recommendation. Also we have applied for the Substrate Builders Programm and  have proceeded with general interview to iterate around steps going forward. And we are planning to start discussion with Blockchers.
