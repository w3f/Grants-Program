...
Liberland’s State project could be summarized by two concepts: Minimal state and distributive governance. Our goal is to put Liberland's e-governance services on a substrate based chain, being the first nation state in the world to serve our citizen in a truly web3 decentralized way.
...
| 2. | Company Registration Pallet | We will create a module that allows anyone that is holding LLM to incorporate a company | 
