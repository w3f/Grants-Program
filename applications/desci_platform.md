...
Use Case Diagram below shows the scope of POC stage.

[![Use-Case-POS.png](https://i.postimg.cc/ydZNzX4j/Use-Case-POS.png)](https://postimg.cc/1nySGFzV)
...
|      4. |Polkadot wallet integration                        | It will be add opportunity to authorize and authentificate to application with Polkadot wallet.                                                                                                                                                                                                                                                      |
|      5. |UI for DeSci project and access to content         | We will implement UI pages which allow to manage DeSci project (create and edit info), upload content and manage access to the project based on wallet integration.                                                                                                                                                                                  |
...
## Future Plans
After building POS and fully testing its scope, we are going to realize full DeSci platform functionality (it is described in "Project Details" section) including XCM integration for multi-chain support.
