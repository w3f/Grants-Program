...
|     2. | Substrate module: user | The mock user pallet will be replaced by a user pallet with usage of TEE. We are not planning to implement the whole TEE on our chain, instead, there are various TEE and DID providers on Polkadot ecosystem, and we will use their service to connect to our blockchain. We already have an initial cooperation plan with Litentry, who has their DID data stored on TEE.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
