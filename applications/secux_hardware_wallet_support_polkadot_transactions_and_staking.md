...
|      1. | SecuX SDK Polkadot support npm version | Development of SDK API for Polkadot.js. This SDK will be reusable for parachains, enabling them to integrate and support our hardware wallet seamlessly.                                                                                                                                                                                                                                                                                   |
|      2. | SecuX SE Firmware version number       | Development of Secure Element (SE) Firmware. This firmware will be designed to be reusable across parachains, facilitating secure integration with our hardware wallet. To implement and verify compatibility with BIP32-ED25519 seed phrase recovery, ensuring that accounts generated by Ledger are compatible with SecuX and vice versa. Users can switch between Ledger and SecuX devices without worrying about compatibility issues. |
|      3. | SecuX MCU Firmware version number      | Development of MCU Firmware including transection confirmation, transection details, account balance. This firmware will also be reusable for parachains to ensure smooth and secure integration with our hardware wallet.                                                                                                                                                                                                                 |
