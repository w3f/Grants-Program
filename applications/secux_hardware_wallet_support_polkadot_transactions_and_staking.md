...
| -----: | ------------------------------------------------------- | -------- |
|    1a. | Collaborative Efforts and Communication                 | 6 weeks  |
|    1b. | Polkadot Integration of SecuX SDK Support               |          |
|    1c. | Development of SDK API for Polkadot.js                  |          |
|    1d. | Development of Secure Element (SE) Firmware             |          |
|    1e. | Development of MCU Firmware                             |          |
|    1f. | Adding Support to the SecuX Crypto Coin Connect Library |          |
|    1g. | Test of the SecuX Web Portal                            |          |
|    1h. | Provide SDK API for Polkadot.js                         |          |
|    2a. | SE and MCU Firmware updates                             | 6 weeks  |
|    2b. | Test of Web Portal UI/UX and Hardware                   |          |
|    2c. | End-to-End and Acceptance Testing of the Web Portal     |          |
