...
-Documentation:
    ...
    - After the update, this project ignore the previous packages when generating & importing the wallet to be used for the transactions, to matche the addresses with TrustWallet & Metamask, it used the official TrustWallet package
