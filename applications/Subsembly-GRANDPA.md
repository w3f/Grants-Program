...
|     7. | Documentation                  | We will provide both **inline documentation** of the module as-well as update the official [documentation](https://subsembly.gitbook.io/subsembly/) of Subsembly.                                                            |
|     8. | Testing Guide                  | We will provide testing information. How one can set keys, purge them and verify that the session rotates.                                                                                                                   |
...
|     4. | Documentation         | We will provide both **inline documentation** of the module as-well as update the official [documentation](https://subsembly.gitbook.io/subsembly/) of Subsembly.                     |
|     5. | Testing Guide         | We will provide testing information on how someone can verify that sessions are being changed, as-well as verify that consensus logs are being deposited.                             |
...
|     4. | Documentation                         | We will provide both **inline documentation** of the module as-well as update the official [documentation](https://subsembly.gitbook.io/subsembly/) of Subsembly.                                                                                      |
|     5. | Testing Guide                         | We will provide testing information on how someone can cause equivocation by a malicious node and verify that he is receiving a reward.                                                                                                                |
