...
* Our project is directly related to gaming and E-sport, we also plan to provide a platform for the exchange and sale of in-game NFT-Tokens.
...
Vitaliy Novak
* Game Developer
* Vertx, Spring, C#, Unity, Java, MySql, Apache Cassandra
* Have written 2 games at Android and IOS platforms, written clients for 2 games, at now, work at 3D game

### Team Code Repos
* https://github.com/Daelon02
* https://github.com/L0nelyStrangrr

### Team LinkedIn Profiles
* https://www.linkedin.com/in/sergey-zasorin-1a2516152/
* https://www.linkedin.com/in/nikita-gubin-a00210200/
* https://www.linkedin.com/in/vlad-ilchenko-4295501b9/
* https://www.linkedin.com/in/max-shvachko-95b36918b/
* https://www.linkedin.com/in/yuri-yanitsky-b66268196/
* https://www.linkedin.com/in/vitalii-novak-47b102172/
## Development Status :open_book: 

![](https://github.com/Daelon02/realis/blob/main/Screenshot_4.png)

At the moment, we have finished work on the NFT pallet, started implementing the Realis-API for connecting to the game.

https://realis.network
https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Frpc.realis.network%2F#/explorer
https://github.com/cryptosoulgame/ReAlis-Network


![](https://github.com/Daelon02/realis/blob/main/Screenshot_5.png)
## Development Roadmap :nut_and_bolt: 
![](https://github.com/Daelon02/realis/blob/main/Screenshot_6.png)
...
| 1a. | Realis Node |  Provide node compilation and installation instructions, start the test network|
| 1b. | NFT-Token | We Completed NFT test of testnet |  
| 2a. | realis-game-api | A pallet that allows you to link the game and the blockchain |
| |Function:|1)`pub fn mint_nft()->dispatch::DispatchResult` <br><br> 2)`pub fn breed_nft()->dispatch::DispatchResult`<br><br> 3)`transfer_nft()->dispatch::DispatchResult`<br><br> 4)`transfer()->dispatch::DispatchResult`<br><br> 5)`get_balance()->dispatch::DispatchResult`<br><br> 6)`get_nft()->dispatch::DispatchResult`<br><br> 7)`update_balance()->dispatch::DispatchResult`|
| 2b. | bridge-erc20 | Bridge for trade GOLD to ERC20|
| | Functions:| 1) `pub fn new() -> Self`<br><br> 2)`pub fn set_metadata(&mut self,name: Option<String>,symbol: Option<String>,reference: Option<String>,reference_hash: Option<Base64VecU8>,decimals: Option<u8>, )`<br><br> 3) `pub fn mint(&mut self, account_id: AccountId, amount: U128)`<br><br> 4) `pub fn withdraw(&mut self, amount: U128, recipient: String) -> Promise`<br><br> 5) `pub fn account_storage_usage(&self) -> StorageUsage`|
| 3a. | bridge-erc721 | Bridge for trade NFT-Token to ERC721|
| | Functions:|1)`pub fn transfer_hash(origin, hash: T::Hash, dest_id: bridge::ChainId) -> DispatchResult `<br><br>2)`pub fn transfer_native(origin, amount: BalanceOf<T>, recipient: Vec<u8>, dest_id: bridge::ChainId) -> DispatchResult`<br><br>3)`pub fn transfer_social_tokens(origin,#[compact] token_id: T::SocialTokenId,#[compact] value: T::Balance,recipient: Vec<u8>, dest_id: bridge::ChainId) -> DispatchResult`<br><br>4)`pub fn transfer_erc721(origin, recipient: Vec<u8>, token_id: U256, dest_id: bridge::ChainId) -> DispatchResult`<br><br>5)`pub fn transfer(origin, to: T::AccountId, amount: BalanceOf<T>, r_id: ResourceId) -> DispatchResult`<br><br>6)`pub fn remark(origin, hash: T::Hash, r_id: ResourceId) -> DispatchResult`<br><br>7)`pub fn mint_erc721(origin, recipient: T::AccountId, id: U256, metadata: Vec<u8>, r_id: ResourceId) -> DispatchResult` |
