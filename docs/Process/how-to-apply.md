...
## How to apply:
   ...
   1. Please read our [FAQs](../faq.md), [category guidelines](../Support_Docs/grant_guidelines_per_category.md), [announcement guidelines](../Support_Docs/announcement-guidelines.md) and [Terms & Conditions](../Support_Docs/T&Cs.md) to familiarize yourself with the subtleties of grants, applications and the program as a whole.
   ...
   8. Sign off on the [terms and conditions](../Support_Docs/T&Cs.md) presented by the [CLA assistant](https://github.com/claassistantio) bot as a Contributor License Agreement. You might need to reload the pull request to see its comment.
