...
|-|-|-
| Desktop/Web Wallets | [Talisman Web Application](https://github.com/TalismanSociety/talisman-web) :grey_question: , [AirGap](https://github.com/airgap-it/airgap-wallet) :grey_question: , [Sakura](https://github.com/w3finance/sakura) :grey_question: | User-friendly Wallet based on the [Recovery Pallet](https://github.com/paritytech/substrate/tree/master/frame/recovery)<!-- NO_STATUS_BADGE -->, Web wallets focused on user-onboarding (e.g. using [localStorage](https://github.com/near/near-wallet)<!-- NO_STATUS_BADGE --> )
| Browser Extensions | [Polkadot{.js}](https://github.com/polkadot-js/extension) :grey_question: , [Polkadot-Js-Plus-Extension](https://github.com/Nick-1979/polkadot-Js-Plus-extension) :grey_question: , [SubWallet-Extension](https://github.com/Koniverse/SubWallet-Extension) :grey_question: , [Doter](https://github.com/ChainBridgeNetworkTeam/Doter) :grey_question: , [Enzyme](https://github.com/blockxlabs/enzyme/) :grey_question: , [Speckle OS](https://github.com/GetSpeckle/speckle-browser-extension) :grey_question: | Sign-in with your polkadot, kusama, etc. account.  
| Mobile Wallets|  [Lunie](https://github.com/luniehq/lunie) :grey_question: , [Polkawallet](https://github.com/polkawallet-io/polkawallet-flutter) :grey_question: , [Parity Signer](https://github.com/paritytech/parity-signer) :grey_question: , [imToken](https://github.com/consenlabs/token-core) :grey_question: , [Fearless Wallet Android](https://github.com/soramitsu/fearless-Android) :grey_question: , [Fearless Wallet iOS](https://github.com/soramitsu/fearless-iOS) :grey_question: , [Stylo](https://github.com/stylo-app/stylo) :grey_question: , [Nova Wallet](https://github.com/nova-wallet/nova-utils) :grey_question: , [Fractapp](https://github.com/fractapp/fractapp/) :grey_question: 
| Burner Wallets/Faucet| [KodaDot](https://github.com/vue-polkadot/apps) :grey_question: , [Astar Faucet Bot](https://github.com/AstarNetwork/astar-faucet-bot) :grey_question: | Faucet (a sybil-resistant way to receive free tokens)
...
| Hardware Wallets | [Ledger Polkadot](https://github.com/ZondaX/ledger-polkadot) :grey_question: , [Ledger Kusama](https://github.com/Zondax/ledger-kusama) :grey_question: | Trezor
...
| Validator Dashboards | [Polkacube](https://github.com/hashquark-io/polkacube-frontend) :grey_question: , [YieldScan](https://github.com/buidl-labs/YieldScan) :grey_question: , [Hubble](https://github.com/w3f-community/hubble/tree/master/app/controllers/polkadot) :grey_question: 
...
| Components | Existing projects | Potentially interesting projects
|-|-|-
| Parachain | [Parachain utilities](https://github.com/AcalaNetwork/parachain-utilities) :grey_question: , [Gantree](https://github.com/gantree-io/gantree-core) :grey_question: | Tools to create parachains from frameworks used in other ecosystems |
...
| No-code Platforms | [EzCode's Polkadot.js plugin on Bubble.io](https://github.com/NovaBloq/Bubble-Plugin-Polkadot.js) :grey_question: , [Blackprint Visual Programming Polkadot.js module](https://github.com/Blackprint/nodes-polkadot.js) :grey_question: | |
...
| Components | Existing projects | Potentially interesting projects
|-|-|-
| Scalable Transactions | [Perun channels](https://github.com/perun-network/perun-polkadot-pallet) :grey_question: , [CLI demo of Perun](https://github.com/perun-network/perun-polkadot-demo) :grey_question: , [Astar](https://github.com/AstarNetwork/Astar) :grey_question: , [Celer](https://github.com/celer-network/cChannel-substrate) :grey_question: , [Gunclear](https://github.com/GunClear/Gunero) :grey_question: | roll-ups, DAG-based consensus mechanisms, side chains |
| Bridges |  [interBTC](https://github.com/interlay/interbtc) :grey_question: , [ChainBridge](https://github.com/centrifuge/ChainBridge/) :grey_question: , [EOS by Bifrost](https://github.com/bifrost-finance/bifrost-eos-relay) :grey_question: , [POA <> Substrate](https://github.com/paritytech/parity-bridge) :grey_question: , [Substrate <> Ethereum DAI Bridge](https://github.com/akropolisio/POC-polkadai-bridge) :grey_question: , [Substrate <> Substrate Bridge](https://github.com/paritytech/substrate-bridge-relay) :grey_question: , [BTC by ChainX](https://github.com/chainx-org/ChainX) :grey_question: , [Cosmos-Substrate bridge](https://github.com/ChorusOne/wormhole-bridge) :grey_question: , [Substrate IBC Pallet](https://github.com/octopus-network/substrate-ibc) :grey_question: , [Polkadot Ethereum Bridge](https://github.com/Snowfork/polkadot-ethereum) :grey_question: , [Darwinia](https://github.com/darwinia-network/darwinia) :grey_question: , [Stellar/DeFi Bridge by Pendulum](https://github.com/pendulum-chain/pendulum-prototype) :grey_question: , [Filecoindot](https://github.com/ChainSafe/filecoindot) :grey_question: | ZCash |
| Privacy | [Webb Anon](https://github.com/webb-tools/anon) :grey_question: , [ZeroChain](https://github.com/LayerXcom/zero-chain) :grey_question: , [pLibra (Phala Network)](https://github.com/Phala-Network/phala-blockchain) :grey_question: , [Automata Network](https://github.com/automata-network/automata) :grey_question: , [zCloak Network](https://github.com/zCloak-Network/zcloak-node) :grey_question: , [Zero Network](https://github.com/zero-network/zero) :grey_question: |  [Multi-Asset Shielded Pool (MASP)](https://github.com/anoma/masp)<!-- NO_STATUS_BADGE --> , [Zkay](https://arxiv.org/pdf/2009.01020.pdf), [Zexe](https://eprint.iacr.org/2018/962.pdf)
...
| High availability setup | [Archipel](https://github.com/luguslabs/archipel) :grey_question: , [Polkadot Failover Mechanism](https://github.com/protofire/polkadot-failover-mechanism) :grey_question: 
