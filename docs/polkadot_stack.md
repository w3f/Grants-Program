...
| Social Networking | [Social Network](https://github.com/social-network/blockchain), [SubSocial](https://github.com/dappforce/subsocial-node) :red_circle: , [ZeroDAO](https://github.com/ZeroDAO/ZeroDAO-node) :yellow_circle: , [Myriad Node](https://github.com/myriadsocial/myriad-node) :green_circle: , [Wika Network](https://github.com/randombishop/wika_etl) :red_circle: , [Project Liberty](https://github.com/LibertyDSNP/mrc) :green_circle: | Private instant messenger that uses on-chain identity
