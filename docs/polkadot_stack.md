...
| Privacy | [Webb Anon](https://github.com/webb-tools/anon), [ZeroChain](https://github.com/LayerXcom/zero-chain), [pLibra (Phala Network)](https://github.com/phala-network), [Automata Network](https://github.com/automata-network/automata) |  [Multi-Asset Shielded Pool (MASP)](https://github.com/anoma/masp), [Zether](https://crypto.stanford.edu/~buenz/papers/zether.pdf), [Zexe](https://eprint.iacr.org/2018/962.pdf)
