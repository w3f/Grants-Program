...
- [:wave: Introduction](#wave-introduction)
  ...
  - [Support](#support)
  - [Team](#team)
- [:level\_slider: Grants](#level_slider-levels)
...
Please also heed our [Announcement Guidelines](https://github.com/PolkadotOpenSourceGrants/apply/blob/master/docs/Support%20Docs/announcement-guidelines.md) for grant-related communications.
...
[Requests For Proposals](https://github.com/PolkadotOpenSourceGrants/apply/blob/master/docs/rfps.md) (RFPs) represent concrete ideas for projects that we would like to see implemented. Several teams may apply for the same RFP, so even if another team has already applied to implement a certain RFP, we invite you to do the same if you're interested.
...
### 1. Application
   ...
   7. Sign off on the [terms and conditions](https://github.com/PolkadotOpenSourceGrants/apply/blob/master/docs/Support%20Docs/T%26Cs.md) presented by the [CLA assistant](https://github.com/claassistantio) bot as a Contributor License Agreement. You might need to reload the pull request to see its comment.
