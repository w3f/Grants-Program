...
> **:loudspeaker:** Regular grants are **public** and provide grants of up to **$30,000 for initial applications** and **$100,000 for follow-up** ones, disbursed in **Bitcoin, USDT or DAI**. If you want to apply in **private**, need to be paid out in **fiat** and/or you **seek funding of $100,000+** and your work cannot be split into smaller milestones, you can apply [:arrow_right: here](https://docs.google.com/forms/d/e/1FAIpQLSfMfjiRmDQDRk-4OhNASM6BAKii7rz_B1jWtbCPkUh6N7M2ww/viewform).
