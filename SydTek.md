...
| **1a.** | Specific Coverage | Coverage will span [historical information regarding soulbound tokens]([https://wrenchinthegears.com/wp-content/uploads/2022/05/Vitalek-Buterin-Soulbound-Token-Paper-May-2022.pdf]), [academic sources]([https://bit.ly/3RnCmMy]), and [recent developments]([(https://cryptoslate.com/press-releases/phala-network-releases-first-soulbound-token-use-case-with-phalaworld/]). |
Number | Deliverable | Specification |
| -----: | ----------- | ------------- |
